...
<html>
    <head>
        ...
        <title>Actualizar tipo de vehiculo</title>
    ...
    <body>
        ...
        <div class="border border-primary p-4 w-50 mx-auto">
             <form action="${pageContext.request.contextPath}/tipos?action=actualizar" method="post">
                ...
                <div class="mb-3">
                    <h2 style="color: #253D85;" class="text-center">
                        <i class="bi bi-person-lines-fill"></i> ACTUALIZAR TIPO DE VEHICULO
                    </h2>
                </div>
               <input type="hidden" name="idTipo" value="${tipo.idTipo}" />
                ...
                <div class="mb-3 input-group">
                    ...
                    <input name="nombreTipo" type="text" class="form-control" 
