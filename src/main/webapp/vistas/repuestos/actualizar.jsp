...
<html>
    ...
    <body>
        ...
        <div class="border border-primary p-4 w-50 mx-auto">
            <form action="${pageContext.request.contextPath}/repuestos?action=actualizar" method="post">
                <input type="hidden" name="idRepuesto" value="${repuesto.idRepuesto}" />

                <!-- TÍTULO -->
                <div class="mb-3">
                    <h2 style="color: #253D85;" class="text-center">
                        <i class="bi bi-person-lines-fill"></i> ACTUALIZAR REPUESTO
                    </h2>
                </div>
                <input type="hidden" name="idRepuesto" value="${repuesto.idRepuesto}" />
                ...
                <div class="text-center">
                    ...
                    <a href="${pageContext.request.contextPath}/repuestos" class="btn btn-danger ms-2">
