...
<html>
    ...
    <div class="border border-primary p-4 w-75 mx-auto">

        <form action="${pageContext.request.contextPath}/vehiculos?action=actualizar" method="post">

            <input type="hidden" name="idVehiculo" value="${vehiculo.idVehiculo}" />

            <div class="mb-3 text-center">
                <h2 style="color: #1B3C53;">
                    <i class="bi bi-car-front-fill"></i> ACTUALIZAR VEHÍCULO
                </h2>
            </div>
            ...
            <div class="mb-3 input-group">
                ...
                <input type="text" name="modelo" class="form-control"
                       ...
                       placeholder="Modelo" required style="color:black;">
            </div>
            ...
            <div class="mb-3 input-group">
                ...
                <input type="number" name="anio" class="form-control"
                       value="${vehiculo.anio}"
                       placeholder="Año" required style="color:black;">
            </div>
            ...
            <div class="mb-3 input-group">
                ...
                <input type="text" name="placa" class="form-control"
                       ...
                       placeholder="Placa" required style="color:black;">
            </div>

            <!-- MOTOR -->
            <div class="mb-3 input-group">
                <span class="input-group-text"><i class="bi bi-gear-fill"></i></span>
                <input type="text" name="numMotor" class="form-control"
                       value="${vehiculo.numMotor}"
                       placeholder="Número de motor" required style="color:black;">
            </div>
            ...
            <div class="mb-3 input-group">
                ...
                <input type="text" name="color" class="form-control"
                       ...
                       placeholder="Color" required style="color:black;">
            </div>
            ...
            <div class="mb-3 input-group">
                ...
                <input type="number" name="kilometraje" class="form-control"
                       ...
                       placeholder="Kilometraje" required style="color:black;">
            </div>

            <!-- CHASIS -->
            <div class="mb-3 input-group">
                <span class="input-group-text"><i class="bi bi-shield-lock"></i></span>
                <input type="text" name="numChasis" class="form-control"
                       value="${vehiculo.numChasis}"
                       placeholder="Número de chasis" required style="color:black;">
            </div>
                ...
                <select name="idCliente" required class="form-select">
                    ...
                    <c:forEach var="c" items="${clientes}">
                        <option value="${c.idCliente}"
                                ${vehiculo.idCliente == c.idCliente ? 'selected' : ''}>
                            ${c.nombre} ${c.apellido}
                        </option>
                    </c:forEach>
                </select>
                ...
                <select name="idTipo" required class="form-select">
                    ...
                    <c:forEach var="t" items="${tipos}">
                        <option value="${t.idTipo}"
                                ${vehiculo.idTipo == t.idTipo ? 'selected' : ''}>
                            ${t.nombreTipo}
                        </option>
                    </c:forEach>
                </select>
                ...
                <select name="idMarca" required class="form-select">
                    ...
                    <c:forEach var="m" items="${marcas}">
                        <option value="${m.idMarca}"
                                ${vehiculo.idMarca == m.idMarca ? 'selected' : ''}>
                            ${m.nombreMarca}
                        </option>
                    </c:forEach>
                </select>
            ...
            <div class="mb-3 input-group">
                ...
                <select name="estadoVehiculo" required class="form-select">
                    ...
                    <option value="Activo"        ${vehiculo.estadoVehiculo == 'Activo' ? 'selected' : ''}>Activo</option>
                    <option value="Inactivo"      ${vehiculo.estadoVehiculo == 'Inactivo' ? 'selected' : ''}>Inactivo</option>
                    <option value="Reparacion" ${vehiculo.estadoVehiculo == 'En reparacion' ? 'selected' : ''}>En reparacion</option>
                    <option value="Vendido"       ${vehiculo.estadoVehiculo == 'Vendido' ? 'selected' : ''}>Vendido</option>
                </select>
            </div>
