...
<html>
    ...
    <body>
        ...
        <div class="border border-primary p-4 w-50 mx-auto">
            <form action="${pageContext.request.contextPath}/proveedores?action=actualizar" method="post">
                <input type="hidden" name="idServicio" value="${servicio.idServicio}" />

                <!-- TÍTULO -->
                <div class="mb-3">
                    <h2 style="color: #253D85;" class="text-center">
                        <i class="bi bi-box-seam"></i> ACTUALIZAR PROVEEDOR
                    </h2>
                </div>
                ...
                <div class="mb-3 input-group">
                    ...
                    <input name="tipoProveedor" type="text" class="form-control" 
                           placeholder="estado"
