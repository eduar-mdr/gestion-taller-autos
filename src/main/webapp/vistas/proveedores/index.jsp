<%-- 
    Document   : index
    Created on : 13 nov 2025, 4:15:06 p. m.
    Author     : MINEDUCYT
--%>
       ...
       <!-- Menú principal -->
        ...
        <div class="container mt-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h2 class="mb-0">Catálogo de proveedores</h2>

                <a href="${pageContext.request.contextPath}/proveedores?action=crear" 
            ...
            <table class="table table-bordered border-dark-subtle table-striped table-hover" id="tablaProveedores">
                <thead class="" >
                    <tr>
                        <th>ID</th>
