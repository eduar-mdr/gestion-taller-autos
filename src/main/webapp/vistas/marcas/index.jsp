<%-- 
    Document   : index
    Created on : 11 nov 2025, 11:34:40 p. m.
    Author     : MINEDUCYT
--%>
...
<html>
    <head>
        ...
        <title>Gestión de marcas de vehiculos</title>
       ...
       <!-- Menú principal -->
        ...
        <div class="container mt-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h2 class="mb-0">Catálogo de marcas de vehiculos</h2>

                <a href="${pageContext.request.contextPath}/marcas?action=crear" 
                    ...
                    <c:forEach var="m" items="${marcas}">
                        <tr>
                            ...
                            <td class="text-nowrap">
                               ...
                               <!-- Botón Editar -->
                                <form action="${pageContext.request.contextPath}/marcas" 
                                      method="post" 
                                      class="d-inline">

                                    <input type="hidden" name="action" value="editar">
                                    <input type="hidden" name="idMarca" value="${m.idMarca}">
                                ...
                                <form action="${pageContext.request.contextPath}/marcas" 
                                      method="post" 
                                      class="d-inline"
                                      onsubmit="return confirm('¿Estás seguro de eliminar esta marca de vehiculo?');">
