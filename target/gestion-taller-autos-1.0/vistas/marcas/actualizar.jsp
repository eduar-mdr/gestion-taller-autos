...
<html>
    <head>
        ...
        <title>Actualizar marca de vehiculo</title>
    ...
    <body>
        ...
        <div class="border border-primary p-4 w-50 mx-auto">
            <form action="${pageContext.request.contextPath}/marcas?action=actualizar" method="post">
                ...
                <div class="mb-3">
                    <h2 style="color: #253D85;" class="text-center">
                        <i class="bi bi-person-lines-fill"></i> ACTUALIZAR MARCA
                    </h2>
                </div>
                <input type="hidden" name="idMarca" value="${marca.idMarca}" />
