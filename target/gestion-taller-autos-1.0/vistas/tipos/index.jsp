<%-- 
    Document   : index
    Created on : 11 nov 2025, 9:14:28 p. m.
    Author     : 
--%>
...
<html>
    <head>
        ...
        <title>Gestión de tipo de vehiculos</title>
       ...
       <!-- Menú principal -->
        ...
        <div class="container mt-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h2 class="mb-0">Catálogo de tipo de vehiculos</h2>

                <a href="${pageContext.request.contextPath}/tipos?action=crear" 
                    ...
                    <c:forEach var="t" items="${tipos}">
                        <tr>
                            ...
                            <td class="text-nowrap">
                               ...
                               <!-- Botón Editar -->
                                <form action="${pageContext.request.contextPath}/tipos" 
                                      method="post" 
                                      class="d-inline">
