<%-- 
    Document   : crear
    Created on : 11 nov 2025, 8:54:01 p. m.
    Author     : MINEDUCYT
--%>
...
<html>
    ...
    <div class="border border-black p-4 w-50 mx-auto">
        <form action="${pageContext.request.contextPath}/tipos?action=guardar"" method="post">
            <div class="mb-3">
                <h2 style="color: #234C6A;" class="text-center">
                    <i class="bi bi-car-front"></i> TIPO DE VEHICULO</h2>
            </div>
            <div class="mb-3 input-group">
                <span class="input-group-text"><i class="bi bi-car-front"></i></span>
                <input name="nombreTipo" type="text" class="form-control" placeholder="Tipo" required style="color: black;">
            </div>
            <div class="text-center">
                <button type="submit" class="btn btn-success">
                    <i class="bi bi-save"></i> Guardar
                </button>
                <a href="${pageContext.request.contextPath}/tipos" class="btn btn-danger ms-2">
